    ...
    <div className="flex flex-col items-center justify-center">
      ...
      <main className="flex w-full flex-col items-center">
        <section className="mt-10 grid w-full max-w-6xl grid-cols-1 gap-6 px-4 md:-mt-8 md:grid-cols-3 lg:-mt-26 lg:gap-10">
          <div className="flex flex-col gap-4 rounded-2xl border bg-white p-5 lg:gap-6 lg:p-8">
            <Users className="text-primary-500 h-5 w-5 lg:h-7 lg:w-7" />
            ...
            <Link
              href="/fundacja"
              className="text-primary-500 flex items-center gap-2 text-sm font-semibold transition-all hover:gap-3 lg:text-base"
            >
          ...
          <div className="flex flex-col gap-4 rounded-2xl border bg-white p-5 lg:gap-6 lg:p-8">
            <HomeIcon className="text-primary-500 h-5 w-5 lg:h-7 lg:w-7" />
          ...
          <div className="flex flex-col gap-4 rounded-2xl border bg-white p-5 lg:gap-6 lg:p-8">
            <HeartHandshake className="text-primary-500 h-5 w-5 lg:h-7 lg:w-7" />
          ...
          <Section.Content align="center">
            <div className="flex flex-col justify-center gap-8 md:flex-row md:items-center lg:gap-14">
              <div className="flex flex-col gap-4 lg:gap-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white md:mx-auto lg:h-20 lg:w-20">
              ...
              <div className="flex flex-col gap-4 lg:gap-6">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white md:mx-auto lg:h-20 lg:w-20">
                  <Stethoscope className="text-primary-500 h-5 w-5 lg:h-8 lg:w-8" />
                </div>
          ...
          <Section.Content align="center">
            <div className="flex flex-col gap-6 md:flex-row lg:gap-14">
              <div className="flex flex-1 flex-col gap-6">
                <p className="text-primary font-mogra -mb-5 text-4xl font-bold lg:text-7xl">1.</p>
              ...
              <div className="flex flex-1 flex-col gap-6">
                <p className="text-primary font-mogra -mb-5 text-4xl font-bold lg:text-7xl">2.</p>
              ...
              <div className="flex flex-1 flex-col gap-6">
                <p className="text-primary font-mogra -mb-5 text-4xl font-bold lg:text-7xl">3.</p>
