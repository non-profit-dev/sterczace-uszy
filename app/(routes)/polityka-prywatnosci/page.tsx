  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <main className="my-10 flex w-full max-w-6xl flex-col items-center gap-y-12 px-4 lg:my-20 lg:gap-y-16">
        <section className="prose prose-lg w-full max-w-none">
          <div className="mb-12 rounded-lg bg-gray-100 p-8">
            <h2 className="mb-4 flex items-center gap-3 text-2xl font-bold lg:text-3xl">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-lg">Wpisujesz je sam(a) w formularzu kontaktowym.</p>
              </div>
              ...
              <div>
                <h3 className="mb-3 text-xl font-semibold lg:text-2xl">Zostawiasz swoją opinię</h3>
                <p className="mb-3 text-lg">
              ...
              <div>
                <h3 className="mb-3 text-xl font-semibold lg:text-2xl">Wspierasz naszą fundację</h3>
                <p className="mb-3 text-lg">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 text-lg">Dane osobowe mogą być przetwarzane w celu:</p>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="mb-2 text-xl font-semibold">Prawo dostępu do danych</h3>
                <p className="text-lg">
              ...
              <div>
                <h3 className="mb-2 text-xl font-semibold">Prawo żądania sprostowania danych</h3>
                <p className="text-lg">
              ...
              <div>
                <h3 className="mb-2 text-xl font-semibold">Prawo do przenoszenia danych</h3>
                <p className="text-lg">
              ...
              <div>
                <h3 className="mb-2 text-xl font-semibold">Prawo wniesienia sprzeciwu</h3>
                <p className="text-lg">
              ...
              <div>
                <h3 className="mb-2 text-xl font-semibold">Prawo wycofania zgody</h3>
                <p className="text-lg">
          ...
          <section className="mb-12">
            <h2 className="mb-6 text-2xl font-bold lg:text-3xl">Dlaczego prosimy o Twoje dane?</h2>
            <p className="text-lg">
