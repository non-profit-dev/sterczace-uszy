  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 lg:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="border-primary-500 rounded-lg border-l-4 bg-white p-6 shadow-sm">
            <div className="mb-3 flex gap-3">
              <Activity className="text-primary-500 h-6 w-6 shrink-0 lg:h-8 lg:w-8" />
              <h4 className="text-lg font-bold lg:text-xl">
                Pies potrzebuje bardzo aktywnego domu
              </h4>
            </div>
            <p>
          ...
          <div className="border-primary-500 rounded-lg border-l-4 bg-white p-6 shadow-sm">
            <div className="mb-3 flex gap-3">
              <Baby className="text-primary-500 h-6 w-6 shrink-0 lg:h-8 lg:w-8" />
              <h4 className="text-lg font-bold lg:text-xl">Pies nie akceptuje dzieci</h4>
            </div>
            <p>
          ...
          <div className="border-primary-500 rounded-lg border-l-4 bg-white p-6 shadow-sm">
            <div className="mb-3 flex gap-3">
              <Dog className="text-primary-500 h-6 w-6 shrink-0 lg:h-8 lg:w-8" />
              <h4 className="text-lg font-bold lg:text-xl">Pies nie toleruje innych zwierząt</h4>
            </div>
            <p>
          ...
          <div className="border-primary-500 rounded-lg border-l-4 bg-white p-6 shadow-sm">
            <div className="mb-3 flex gap-3">
              <Home className="text-primary-500 h-6 w-6 shrink-0 lg:h-8 lg:w-8" />
              <h4 className="text-lg font-bold lg:text-xl">Warunki mieszkaniowe</h4>
            </div>
            <p>
          ...
          <div className="border-primary-500 rounded-lg border-l-4 bg-white p-6 shadow-sm md:col-span-2">
            <div className="mb-3 flex gap-3">
              <GraduationCap className="text-primary-500 h-6 w-6 shrink-0 lg:h-8 lg:w-8" />
              <h4 className="text-lg font-bold lg:text-xl">
                Pies potrzebuje doświadczonego opiekuna
              </h4>
            </div>
            <p>
      ...
      <div className="bg-primary-500 rounded-lg p-8 text-center text-white">
        ...
        <p className="flex items-center justify-center gap-2 text-lg lg:text-xl">
